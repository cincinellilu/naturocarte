          ...
          <div className="page-hero-copy practitioners-hero-copy">
            ...
            {auth === "sent" ? (
              <p className="practitioner-form-feedback practitioner-form-feedback--success">
                L’email de connexion NaturoCarte a été envoyé. Ouvrez votre boîte mail pour accéder à votre espace.
              </p>
            ) : null}
      ...
      <section className="section-shell practitioner-offers-section" id="offres">
        <div className="section-heading section-heading--stacked">
          ...
          <p className="section-intro">
            ...
            les avis, les tarifs et les informations enrichies pour les praticiens qui veulent piloter leur
